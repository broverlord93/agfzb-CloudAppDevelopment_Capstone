...
urlpatterns = [
    ...
    path(route='dealership/<str:state>', view=views.get_dealership_by_id, name='dealership_by_state'),
    path(route='dealership/<int:dealerId>/<str:state>', view=views.get_dealership_by_id,
         name='dealership_by_id_and_state'),
